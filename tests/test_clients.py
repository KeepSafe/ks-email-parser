...
class TestParser(TestCase):
    ...
    def test_globale_text(self):
        self._run_and_assert('email_globale.text', 'email_globale.text')

    def test_globale_html(self):
        self._run_and_assert('email_globale.html', 'email_globale.html')
